...
public class FindUsersByEmail extends AbstractMetaModelBean {
...
//		String inBody = exchange.getIn().getBody(String.class);
		...
		try {
			...
			emailSearchable = input.get("emailkeyword").toString();
		...
		List usrList = adminService.findUserByEmailPaginated(emailSearchable, domain, pageIndex, pageSize);
