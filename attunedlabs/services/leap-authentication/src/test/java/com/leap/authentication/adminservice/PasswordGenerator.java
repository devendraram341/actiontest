...
public class PasswordGenerator {
	...
	public PasswordGenerator() {
		// throw new UnsupportedOperationException("Empty constructor is not
		// supported.");
	}
	...
	public static class PasswordGeneratorBuilder {
		 ...
		 *
		 * @param useDigits
		 *            true in case you would like to include digit characters
		 *            (123..). Default false.
		 * @return the builder for chaining.
		 */
		 ...
		 *            true in case you would like to include punctuation
