 ...
 *
 */
public class AssertResourceAvailabilityException extends LeapAuthorizationFailedException {
	private static final long serialVersionUID = 5735431728215179209L;

	public AssertResourceAvailabilityException(String message, Throwable cause, String developerMessage,
			Integer errorCode) {
		super(message, cause);
