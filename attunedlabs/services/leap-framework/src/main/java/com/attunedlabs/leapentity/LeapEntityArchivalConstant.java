...
public class LeapEntityArchivalConstant {
	...
	public static final String HOST = "cassandra_host";
	public static final String PORT = "cassandra_port";
	public static final String URL = "cassandra_url";
	public static final String DRIVER_CLASS = "cassandra_driver_class";
	public static final String KEYSPACE = "cassandra_keyspace";
