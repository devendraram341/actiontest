...
public abstract class LeapConfigurationListener implements EntryAddedListener<String, ConfigurationUnit>,
		EntryRemovedListener<String, ConfigurationUnit>, EntryUpdatedListener<String, ConfigurationUnit>,
		EntryEvictedListener<String, ConfigurationUnit>, MapEvictedListener, MapClearedListener {
