...
public class LeapMetaModelHelper {
	 ...
	 */
	protected static Query buildJoinQueries(DataContext jdbcDataContext, Table fromTable, Table joinTable,
	...
	protected static String getMappedStringFromList(String substitutableString, List<?> substitutableValues) {
		String methodParam = "Keys: " + substitutableString + " Values: " + substitutableValues;
		String methodName = "getMappedStringFromList";
		logger.debug("{} entered into the method {} predicates{} {}", LEAP_LOG_KEY, methodName, methodParam);
		String temp = "";
		...
		logger.debug("{} Predicates Mapped and returning: {}", LEAP_LOG_KEY, substitutableString);
	...
	protected static FilterItem getFilterItem(String predicates) throws InvalidPredicateException {
		String methodName = "getFilterItem";
		logger.debug("{} entered into the method {} predicates{}", LEAP_LOG_KEY, methodName, predicates);
		if (predicates == null) {
