...
public class SubscriptionNoRetryPolicy {
	...
	/**
	 * #TODO Implementation for this configuration will change not to be handled on
	 * the retry side. (Currently used as the configuration will decide the async
	 * call after msg consumed from topic by particular subscriber.)
	 */
