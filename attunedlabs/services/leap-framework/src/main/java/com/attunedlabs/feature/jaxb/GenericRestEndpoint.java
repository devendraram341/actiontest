...
public class GenericRestEndpoint implements Serializable {
	...
	@XmlAttribute(name = "prettyuri")
	protected String prettyuri;
	...
	public String getPrettyuri() {
		return prettyuri;
	}

	public void setPrettyuri(String prettyuri) {
