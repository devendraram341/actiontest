...
public class SubscriptionConstant {
	...
	public final static String KAFKA_MANUAL_COMMIT_ENABLE_URL_KEY = "$allowManualCommit$";
	...
	public final static String KAFKA_MANUAL_COMMIT_ENABLE_CONFIG_KEY = "allowManualCommit";
	...
	public final static String KAFKA_AUTO_ENDPOINT_URI = "kafka:$topicName$?brokers=$kafkaBrokerHostPort$"
			+ "&groupId=$groupId$" + "&clientId=$clientId$" + "&consumersCount=$consumerCount$"
			+ "&autoCommitEnable=$autoCommitEnable$" + "&autoCommitOnStop=$autoCommitOnStop$"
			+ "&autoOffsetReset=$autoOffsetReset$" + "&maxPollRecords=$maxPollRecords$"
			+ "&pollTimeoutMs=$pollTimeoutMs$" + "&sessionTimeoutMs=$sessionTimeoutMs$"
			+ "&consumerRequestTimeoutMs=$consumerRequestTimeoutMs$" + "&fetchWaitMaxMs=$fetchWaitMaxMs$"
			+ "&autoCommitIntervalMs=$autoCommitIntervalMs$";

	public final static String KAFKA_MANUAL_ENDPOINT_URI = "kafka:$topicName$?brokers=$kafkaBrokerHostPort$"
			+ "&groupId=$groupId$" + "&clientId=$clientId$" + "&consumersCount=$consumerCount$"
			+ "&allowManualCommit=$allowManualCommit$" + "&autoOffsetReset=$autoOffsetReset$"
			+ "&maxPollRecords=$maxPollRecords$" + "&pollTimeoutMs=$pollTimeoutMs$"
			+ "&sessionTimeoutMs=$sessionTimeoutMs$" + "&consumerRequestTimeoutMs=$consumerRequestTimeoutMs$"
	...
	public final static String JMS_QUARTZ_ENDPOINT_URI = "quartz2://jmsSubsciptionTracking/"
			+ "retryFailedJmsSubscription?cron=$cron$&stateful=true";
	...
	public static final String SEDA_ENDPOINT_URI = "seda:subscriptionRouteForRetry?concurrentConsumers=$concurrentConsumers$&waitForTaskToComplete=never";
	...
	public static final String PARALLEL_PROCESS_ROUTE_URI = "seda:parallelProcessingSubscriberRoute$subscriptionId$?concurrentConsumers=$concurrentConsumers$&waitForTaskToComplete=never&size=$queueSize$&blockWhenFull=true";
	public final static String PARALLEL_PROCESSING_ROUTE = "seda:parallelProcessingSubscriberRoute";
	public final static String PARALLEL_PROCESSING_ENDPOINT = "?waitForTaskToComplete=never";
	public final static String SEDA_SUBSCRIBER_QUEUE_SIZE = "$queueSize$";
	public final static String SEDA_SUBSCRIBER_QUEUE_SIZE_KEY = "queueSize";
	...
	public final static String PARALLEL_PROCESSING_ROUTE_ENDPOINT = "seda:parallelProcessingSubscriberRoute?waitForTaskToComplete=never";
	...
	public static final String DEFAULT_SUBSCRIBER_QUEUE_SIZE_VALUE = "1000";
	...
	public static final String DEFAULT_MANUAL_COMMIT_ENABLE_VALUE = "false";
	...
	public static final String IS_JMS_SUBSCRIPTION_INVOCATION_KEY = "jmsSubscriptionInvocation";
	...
	public static final String EVENT_FETCHED_DTM = "eventFetchDtm";
	public static final String EVENT_LAST_FAILED_DTM = "lastFailureDtm";
	...
	// jms configuration
	public final static String JMS_MANUAL_ENDPOINT_URI = "jms:queue:$queueName$";
	public final static String JMS_MANUAL_RETRY_ENDPOINT_URI = "jms:queue:$queueName$";
	public final static String JMS_QUEUE_NAME_URL_KEY = "$queueName$";
	public final static String JMS_SUBSCRIPTION_NAME_URL_KEY = "$subscriptionName$";
	public final static String JMS_CONCURRENT_CONSUMEER_URL_KEY = "$concurrentConsumers$";
	public final static String JMS_ACKNOLEDGEMENT_MODE_URL_KEY = "$acknowledgementModeName$";
	public static final String JMS_SUBSCIBER_EVENT_CONFIG_KEY = "JMSSubscriberEvent";
	public static final String JMS_CALL = "jComponentInvocation";
	public static final String RETRY_QUEUE_CONFIG = "retryQueueConfig";
	public static final String RETRY_QUEUE_NAME = "retryQueueName";
	public static final String RETRY_CONSUMERS = "retryConsumers";

	public final static String JMS_LEAP_DEFAULT_RETRY_STRATEGY_CLASS = "JMSLeapDefaultRetryStrategy";

	public final static String JMS_CONSUMER_MANUAL_ENDPOINT_URI = "jms:queue:$queueName$?concurrentConsumers=$concurrentConsumers$"
			+ "&subscriptionName=$subscriptionName$&acknowledgementModeName=$acknowledgementModeName$&disableReplyTo=true";

	public final static String JMS_RETRY_CONSUMER_MANUAL_ENDPOINT_URI = "jms:queue:$queueName$?concurrentConsumers=$concurrentConsumers$"
			+ "&subscriptionName=$subscriptionName$&acknowledgementModeName=$acknowledgementModeName$";
