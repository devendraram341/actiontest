...
public class FeatureDeployment implements Serializable {
	...
	public FeatureDeployment(int featureMasterId, String featureName, String implementationName, String vendorName,
			String featureVersion, boolean isActive, boolean isPrimary, boolean isCustomized, String provider) {
	...
	public FeatureDeployment(int id, int featureMasterId, String featureName, String implementationName,
			String vendorName, String featureVersion, boolean isActive, boolean isPrimary, boolean isCustomized) {
		this.id = id;
		this.featureMasterId = featureMasterId;
		this.featureName = featureName;
		this.implementationName = implementationName;
	...
	public FeatureDeployment(int featureMasterId, String featureName, String implementationName, String vendorName,
			String featureVersion, boolean isActive, boolean isPrimary, boolean isCustomized) {
		this.featureMasterId = featureMasterId;
		this.featureName = featureName;
		this.implementationName = implementationName;
		this.vendorName = vendorName;
	...
	public String toString() {
		return "FeatureDeployment [id=" + id + ", featureMasterId=" + featureMasterId + ", featureName=" + featureName
				...
				+ isCustomized + ", provider=" + provider + ", vendorTaxonomyId=" + vendorTaxonomyId + "]";
	}
