    ...
    implements Serializable
{
    ...
    protected List<EntityIndex> entityIndex;
     ...
     * This is why there is not a <CODE>set</CODE> method for the entityIndex property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEntityIndex().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<EntityIndex> getEntityIndex() {
        if (entityIndex == null) {
            entityIndex = new ArrayList<EntityIndex>();
        }
