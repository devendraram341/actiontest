...
public interface ITenantConfigTreeService {
	...
	public ConfigurationTreeNode getPrimaryVendorForFeature(String tenantName, String siteName, String featureGroup,String feature, String implementation) throws UndefinedPrimaryVendorForFeature;
