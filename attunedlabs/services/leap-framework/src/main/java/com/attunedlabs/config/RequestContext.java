...
public class RequestContext implements Serializable {
	...
	public ConfigurationContext getConfigurationContext() {
		return new ConfigurationContext(this.tenantId, this.siteId, this.featureGroup, this.featureName,
				this.implementationName, this.vendor, this.version, this.provider, this.vendorTaxonomyId);
	}
	...
	public String toString() {
		return "RequestContext [tenantId=" + tenantId + ", siteId=" + siteId + ", featureGroup=" + featureGroup
				...
				+ ", version=" + version + ", requestId=" + requestId + ", provider=" + provider + ", vendorTaxonomyId="
				+ vendorTaxonomyId + "]";
	}
