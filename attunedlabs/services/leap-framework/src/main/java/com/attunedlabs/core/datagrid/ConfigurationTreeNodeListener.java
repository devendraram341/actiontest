...
public abstract class ConfigurationTreeNodeListener implements EntryAddedListener<String, Serializable>,
		EntryRemovedListener<String, Serializable>, EntryUpdatedListener<String, Serializable>,
		EntryEvictedListener<String, Serializable>, MapEvictedListener, MapClearedListener {
	...
	public void entryEvicted(EntryEvent<String, Serializable> evictedEvent) {
		logger.debug("{} .entryEvicted method of ConfigurationTreeNodeListener", LEAP_LOG_KEY);
	...
	public void mapEvicted(MapEvent mapEvictedEvent) {
		logger.debug("{} .mapEvicted method of ConfigurationTreeNodeListener", LEAP_LOG_KEY);
	}

	@Override
	public void mapCleared(MapEvent mapClearedEvent) {
		logger.debug("{} .mapCleared method of ConfigurationTreeNodeListener", LEAP_LOG_KEY);
	}
