...
@XmlType(name = "", propOrder = { "subscribeEvent", "jmsSubscribeEvent" })
public class EventSubscription implements Serializable {
	...
	@XmlElement(name = "JMSSubscriberEvent")
	protected List<JMSSubscribeEvent> jmsSubscribeEvent;
	 ...
	 * <CODE>set</CODE> method for the subscribeEvent property.
	 * 
	 * <p>
	...
	/**
	 * Gets the value of the jmsSubscribeEvent property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the jmsSubscribeEvent property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getJmsSubscribeEvent().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	 * Objects of the following type(s) are allowed in the list
	 * {@link JMSSubscribeEvent }
	 * 
	 * 
	 */
	public List<JMSSubscribeEvent> getJmsSubscribeEvent() {
		if (jmsSubscribeEvent == null) {
			jmsSubscribeEvent = new ArrayList<JMSSubscribeEvent>();
		}
		return this.jmsSubscribeEvent;
	}
