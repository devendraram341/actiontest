...
public class HsqldbQueryRewriter extends DefaultQueryRewriter {
	...
	/**
	 * HSQL converts all non-escaped characters to uppercases, this is prevented by
	 * always escaping
	 */
	@Override
	public boolean needsQuoting(String alias, String identifierQuoteString) {

		boolean containsLowerCase = CharMatcher.javaLowerCase().matchesAnyOf(identifierQuoteString);
